...
public final class R {
  ...
  public static final class styleable {
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #CoordinatorLayout_keylines io.flutter.plugins.cameraexample:keylines}</code></td><td>A reference to an array of integers representing the
     * locations of horizontal keylines in dp from the starting edge.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_statusBarBackground io.flutter.plugins.cameraexample:statusBarBackground}</code></td><td>Drawable to display behind the status bar when the view is set to draw behind it.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name io.flutter.plugins.cameraexample:keylines
     */
     ...
     * "<code>#<i>aarrggbb</i></code>".
     *
     * @attr name io.flutter.plugins.cameraexample:statusBarBackground
     */
     ...
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_anchor io.flutter.plugins.cameraexample:layout_anchor}</code></td><td>The id of an anchor view that this view should position relative to.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_anchorGravity io.flutter.plugins.cameraexample:layout_anchorGravity}</code></td><td>Specifies how an object should position relative to an anchor, on both the X and Y axes,
     * within its parent's bounds.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_behavior io.flutter.plugins.cameraexample:layout_behavior}</code></td><td>The class name of a Behavior class defining special runtime behavior
     * for this child view.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_dodgeInsetEdges io.flutter.plugins.cameraexample:layout_dodgeInsetEdges}</code></td><td>Specifies how this view dodges the inset edges of the CoordinatorLayout.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_insetEdge io.flutter.plugins.cameraexample:layout_insetEdge}</code></td><td>Specifies how this view insets the CoordinatorLayout and make some other views
     * dodge it.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_keyline io.flutter.plugins.cameraexample:layout_keyline}</code></td><td>The index of a keyline this view should position relative to.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name io.flutter.plugins.cameraexample:layout_anchor
     */
     ...
     * </table>
     *
     * @attr name io.flutter.plugins.cameraexample:layout_anchorGravity
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name io.flutter.plugins.cameraexample:layout_behavior
     */
     ...
     * </table>
     *
     * @attr name io.flutter.plugins.cameraexample:layout_dodgeInsetEdges
     */
     ...
     * </table>
     *
     * @attr name io.flutter.plugins.cameraexample:layout_insetEdge
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name io.flutter.plugins.cameraexample:layout_keyline
     */
